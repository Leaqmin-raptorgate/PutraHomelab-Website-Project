<template>
          <div
            class="invisible absolute top-full left-0 w-48 translate-y-2 rounded-b-md border border-slate-700 bg-lab-surface opacity-0 shadow-xl transition-all duration-200 ease-out group-hover:visible group-hover:translate-y-0 group-hover:opacity-100"
          >
